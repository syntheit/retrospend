...
export function ExpenseModal({
	...
	return (
		<Dialog onOpenChange={handleOpenChange} open={open}>
			<DialogContent
				className="top-4 left-1/2 h-[calc(100dvh-2rem)] max-h-[calc(100dvh-2rem)] w-[calc(100%-1rem)] max-w-[calc(100%-1rem)] translate-x-[-50%] translate-y-0 overflow-y-auto sm:left-1/2 sm:top-1/2 sm:h-auto sm:max-h-none sm:w-full sm:max-w-3xl sm:-translate-y-1/2"
				onOpenAutoFocus={(e) => {
