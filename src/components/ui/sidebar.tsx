...
function SidebarProvider({
	...
	const setOpen = React.useCallback(
		(value: boolean | ((value: boolean) => boolean)) => {
			...
			// biome-ignore lint/suspicious/noDocumentCookie: Cookie needed for sidebar state persistence
...
function SidebarTrigger({
	...
	return (
		<Button
			className={cn("relative size-7 after:absolute after:-inset-2 after:content-[''] md:after:hidden", className)}
