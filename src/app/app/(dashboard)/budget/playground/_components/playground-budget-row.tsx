...
export function PlaygroundBudgetRow({
    ...
    const categoryColor = CATEGORY_COLOR_MAP[category.color as keyof typeof CATEGORY_COLOR_MAP] || "bg-gray-500";
	...
	return (
		<div className="group relative flex flex-col gap-4 rounded-xl border p-4 transition-all hover:bg-accent/5 hover:border-indigo-200/50 dark:hover:border-indigo-900/50 lg:flex-row lg:items-center">
