...
function renderActiveShape(
	...
	const { cx, cy, innerRadius, outerRadius, startAngle, endAngle, fill, cornerRadius } =
		props;
	return (
		<Sector
											...
											content={({ viewBox }) => {
												if (viewBox && "cx" in viewBox && "cy" in viewBox) {
													return (
														...
														>
															<tspan
																className="fill-muted-foreground font-medium text-[10px] tracking-wide sm:text-xs"
																x={viewBox.cx}
																y={(viewBox.cy || 0) - 16}
															>
