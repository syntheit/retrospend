...
export function PlaygroundVisuals() {
	...
	return (
		<div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
			<MetricCard
				className="border-none bg-card text-foreground"
				icon={<Receipt />}
			...
			<MetricCard
				className="border-none bg-indigo-600"
				...
				overlay={
					!hasIncome && (
						<div className="absolute inset-0 z-20 flex flex-col items-center justify-center bg-indigo-600/10 p-2 text-center backdrop-blur-[2px]">
							...
							<Link href="/settings">
								<Button
									className="h-8 border-0 bg-foreground/10 px-3 text-xs text-foreground hover:bg-foreground/20"
									size="sm"
									variant="ghost"
								>
									Set in Settings
